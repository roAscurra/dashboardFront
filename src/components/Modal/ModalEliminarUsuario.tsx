...
const ModalEliminarUsuario: React.FC<ModalEliminarUsuarioProps> = ({ show, onHide, usuario, onDelete }) => {
  ...
  const handleDelete = async () => {
    try {
      if (usuario && usuario.id) {
        ...
        onDelete(usuario.id.toString()); // Llama a la función onDelete con el ID del usuario como argumento
      } else {
